...
def train_step(model: torch.nn.Module,
  ...
  loss_fn_ A PyTorch loss function to minimize.
  optimizer: A PyTorch optimizer to help minimze the loss function.
  ...
  for batch, (X, Y) in enumerate(dataloader):
    ...
    # Calculate and accumulate accuray metric across all batches
...
def train(model: torch.nn.Module,
  ...
  In the form: {train_loss: [...],
                  ...
                  test_acc: [...]} 
  """
  # Create empty resutls dictionary
  results = {"train_loss": [],
             "train_acc": [],
             "test_loss": [],
             "test_acc": []
